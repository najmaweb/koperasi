            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<a href="<?php echo base_url();?>icatalogs/"><i title="Lihat Produk yang nonaktif" class="fa fa-trash-o pointer"></i></a>
					<a href="<?php echo base_url();?>catalogs/add"><i title="Penambahan Produk" class="fa fa-plus-circle pointer"></i></a>
                </div><!-- /.box-header -->
                <div class="box-body">
